...
public class Hardware_page6v3 extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hardware_page6v3);
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,
		...
		case R.id.spCLEP2:
			if (countA[2] + countA[3] + countA[4] + countA[5] > 0) {
				countA[2] = 0;
				countA[3] = 0;
				countA[4] = 0;
				countA[5] = 0;
			}
			if (countA[0] + countA[1] + countA[2] + countA[3] + countA[4]
					+ countA[5] > 1) {
		...
		case R.id.spCLEP3:
			if (countA[3] + countA[4] + countA[5] > 0) {
				countA[3] = 0;
				countA[4] = 0;
				countA[5] = 0;
			}
			...
			Spinner spinner4 = (Spinner) findViewById(R.id.spCLEP4);
			spinner4.setAdapter(adapter4);
			spinner4.setOnItemSelectedListener(this);
			break;

		case R.id.spCLEP4:
			if (countA[4] + countA[5] > 0) {
				countA[4] = 0;
				countA[5] = 0;
			}
			if (countA[0] + countA[1] + countA[2] + countA[3] + countA[4]
			...
			Spinner spinner5 = (Spinner) findViewById(R.id.spCLEP5);
		...
		case R.id.spCLEP5:
			...
			Spinner spinner6 = (Spinner) findViewById(R.id.spCLEP6);
