...
public class Hardware_page6v2 extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hardware_page6v2);
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,
		...
		case R.id.spCLEP2:
			if (countA[2] + countA[3] > 0) {
				countA[2] = 0;
				countA[3] = 0;
			}
			if (countA[0] + countA[1] + countA[2] + countA[3] > 1) {
		...
		case R.id.spCLEP3:
			...
			if (countA[0] + countA[1] + countA[2] + countA[3] < 2) {
				setCLEPxaf(pos, 3);
			} else {
				setCLEPxf(pos, 3);
			}
